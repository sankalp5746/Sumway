  ...
  try {
    ...
    const htmlContent = `
      <div style="font-family: sans-serif; max-width: 600px; margin: 0 auto; padding: 20px; border: 1px solid #e2e8f0; border-radius: 8px;">
        <h2 style="color: #0A0F1E; border-bottom: 2px solid #00C2B2; padding-bottom: 10px; text-transform: uppercase;">
          New Board Message
        </h2>
        <table style="width: 100%; border-collapse: collapse; margin-top: 15px;">
          ...
          <tr>
            ...
            <td style="padding: 8px 0; font-weight: bold; color: #F5C542;">${subject}</td>
          </tr>
        </table>
        <div style="margin-top: 20px; padding: 15px; background-color: #f8fafc; border-left: 4px solid #00C2B2; border-radius: 4px;">
