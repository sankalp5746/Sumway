          ...
          {INDUSTRIES.map((ind, index) => (
            ...
            >
              ...
              <div className="absolute inset-0 z-0">
                ...
                />
                <div className="absolute inset-0 bg-gradient-to-t from-[#0A0F1E] light:from-white via-[#0A0F1E]/40 light:via-white/40 to-transparent" />
              ...
              <div className="relative z-10 flex flex-col gap-3">
                ...
                <h3 className="font-display font-extrabold text-xl text-slate-100 light:text-slate-800 tracking-tight leading-tight uppercase group-hover:text-[#F5C542] light:group-hover:text-[#00C2B2] transition-colors">
                  {ind.title}
                </h3>
                ...
                <div className="flex justify-end mt-3 pt-3 border-t border-white/8 light:border-slate-200">
                  <Link
                    href={ind.href}
                    className="flex items-center gap-1.5 text-xs font-bold uppercase tracking-widest text-slate-300 light:text-slate-600 hover:text-[#F5C542] light:hover:text-[#00C2B2] transition-colors"
                  >
